import {THEME_CHANGER, ADD_TO_CART, PRODUCT, SET_SUBDOMAIN} from './actionType.tsx';
...
export const SetSubdomain = (value: any) => async (dispatch: (arg0: { type: string; payload: any }) => void) => {
    dispatch({
        type: SET_SUBDOMAIN,
        payload: value
    });
