...
const Login: FC<LoginProps> = ({ ThemeChanger }: any) => {
  ...
  const [passwordFeedbackMessage, setPasswordFeedbackMessage] = useState(null);
  ...
  const handleSubmit = (event: {
    ...
    login(email, password, remember_me)
      .then(() => {
        ...
        navigator(`/${stores.defaultDashboard}`, { replace: true });
      })
      .catch(error => {
